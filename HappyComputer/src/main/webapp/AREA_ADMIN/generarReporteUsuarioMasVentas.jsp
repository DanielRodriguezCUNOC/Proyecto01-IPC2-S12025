...
<head>
    <meta charset="UTF-8">
    <title>Generar Reporte de Usuario con Más Ventas</title>
    <link href="https://cdn.jsdelivr.net/npm/tailwindcss@2.0.0/dist/tailwind.min.css" rel="stylesheet">
</head>
<body class="bg-gray-100">
<div class="container mx-auto p-4">
    <h1 class="text-2xl font-bold mb-6 text-center">Generar Reporte de Usuario con Más Ventas</h1>
    <form action="${pageContext.request.contextPath}/SvReporteVenta" method="post"
          class="max-w-md mx-auto bg-white p-6 rounded-lg shadow-md">
        <!-- Agregamos un input oculto para el action del post -->
        <input type="hidden" name="action" value="masVentas">
        <div class="mb-4">
