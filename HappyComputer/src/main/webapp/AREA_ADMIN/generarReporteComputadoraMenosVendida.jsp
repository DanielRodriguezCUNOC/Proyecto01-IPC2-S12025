...
<head>
    <meta charset="UTF-8">
    <title>Generar Reporte de Computadora Menos Vendida</title>
    <script src="https://cdn.tailwindcss.com"></script>
</head>
<body class="bg-gray-100">
<div class="container mx-auto p-4">
    <h1 class="text-2xl font-bold mb-6 text-center">Generar Reporte de Computadora Menos Vendida</h1>
    <form action="${pageContext.request.contextPath}/SvReporteComputadora" method="post"
