...
<head>
    <meta charset="UTF-8">
    <title>Generar Reporte de Devoluciones</title>
    <link href="https://cdn.jsdelivr.net/npm/tailwindcss@2.0.0/dist/tailwind.min.css" rel="stylesheet">
</head>
<body class="bg-gray-100">
<div class="container mx-auto p-4">
    <h1 class="text-2xl font-bold mb-6 text-center">Generar Reporte de Devoluciones</h1>
    <form action="${pageContext.request.contextPath}/SvReporteDevolucion" method="post"
